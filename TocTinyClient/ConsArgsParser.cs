...
namespace Null.Library.ConsArgsParser
{
    class ConsArgs
    {
        readonly Dictionary<string, string> stringP = new Dictionary<string, string>();
        readonly List<string> stringL = new List<string>();
        readonly List<string> booleanP = new List<string>();
